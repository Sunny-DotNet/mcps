...
- `index.json` is the registry document. It declares the template index schema, provenance notes, and the canonical `templates` list that points to each `templates/*.mcp.json` file.
